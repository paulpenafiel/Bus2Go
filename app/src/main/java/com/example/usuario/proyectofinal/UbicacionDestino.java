...
public class UbicacionDestino extends FragmentActivity implements OnMapReadyCallback,EncuentraDireccionListener {
    ...
    private void sendRequest() {
        ...
        if (origin.isEmpty()) {
            Toast.makeText(this, "Ingresa la direciccion de origen", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            new EncuentraDireccion(this, origin, destination).execute();
